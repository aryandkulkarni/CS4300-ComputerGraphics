...
void VertexSpecification(){
	...
	*/
	// Another test case you can uncomment which is 'almost flat'
	const std::vector<GLfloat> vertexData
	{
        // 0 - Vertex
	...
	// Let's come down here and create another vertex Buffer object(VBO) for our normals.
...
void Draw(){
    ...
    // Draw a 'line for our normal'
		glUseProgram(gGraphicsPipelineShaderProgramDebug);
		// Need to setup same uniforms for our debug shader
